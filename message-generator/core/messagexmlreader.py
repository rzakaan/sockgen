...
from message_generator.data import *

# ==============================================================================
#                               UTILS
# ==============================================================================

def isAttribExists(node, attrib) -> bool:
    if attrib in node.attrib:
        return True
    else:
        return False

def getAttrib(node, attrib) -> bool:
...
def readDataFields(node) -> List[DataFieldXML]:
...
def readEnumerations(node) -> List[EnumXML]:
...
def readComplexTypes(node) -> List[RecordXML]:
...
def readMessageHeader(node) -> List[RecordElementXML]:
    root = node.find('complex')
    searched = root.findall('record')
...
def readMessages(node) -> List[MessageXML]:
